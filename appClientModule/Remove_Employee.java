...
//        f.add(b3);
        ...
        l6.setForeground(new Color(255,204,51));
        ...
        l3.setForeground(new Color(255,204,51));
        ...
        l7.setForeground(new Color(255,204,51));
        ...
        l4.setForeground(new Color(255,204,51));
        ...
        l8.setForeground(new Color(255,204,51));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select name,phone,email from employee_EMS where emp_id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();
                String str = "delete from employee_EMS where emp_id = '"+t.getText()+"'";
