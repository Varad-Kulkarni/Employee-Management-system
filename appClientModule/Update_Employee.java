...
//        id15.setIcon(img);
        ...
        id9.setForeground(new Color(255,204,51));
        ...
        id10.setForeground(new Color(255,204,51));
    ...
    void showData(String s){
        try{
            conn con = new conn();
            String str = "select * from employee_EMS where emp_id = '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee_EMS set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',post='"+t7.getText()+"',aadhar='"+t8.getText()+"',emp_id='"+t9.getText()+"' where emp_id='"+id_emp+"'";
