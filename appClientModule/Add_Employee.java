...
//        id15.setIcon(img);
        ...
        id11.setForeground(new Color(255,204,51));
        ...
        id12.setForeground(new Color(255,204,51));
        ...
        b.setBackground(new Color(0,255,51));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee_EMS values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"')";
