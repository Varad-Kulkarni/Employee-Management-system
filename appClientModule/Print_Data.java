...
class Print_Data implements ActionListener{
    ...
    Print_Data(String e_id){
        try{
            conn con = new conn();
            String str = "select * from employee_EMS where emp_id = '"+e_id+"'";
...
//        id9.setIcon(img);
        ...
        id8.setForeground(new Color(255,204,51));
        f.add(id8);
        ...
        id4.setForeground(new Color(255,204,51));
        id4.setBounds(50,270,100,30);
        id4.setFont(new Font("serif",Font.BOLD,20));
        f.add(id4);

        aid4= new JLabel(phone);
        aid4.setForeground(new Color(255,204,51));
        ...
        id5.setForeground(new Color(255,204,51));
        id5.setBounds(50,320,100,30);
        id5.setFont(new Font("serif",Font.BOLD,20));
        f.add(id5);

        aid5= new JLabel(email);
        aid5.setForeground(new Color(255,204,51));
        ...
        id6.setForeground(new Color(255,204,51));
        id6.setBounds(50,370,100,30);
        id6.setFont(new Font("serif",Font.BOLD,20));
        f.add(id6);

        aid6= new JLabel(education);
        aid6.setForeground(new Color(255,204,51));
        ...
        id7.setForeground(new Color(255,204,51));
        id7.setBounds(50,420,100,30);
        id7.setFont(new Font("serif",Font.BOLD,20));
        f.add(id7);

        aid7= new JLabel(post);
        aid7.setForeground(new Color(255,204,51));
